...
shinyUI(fluidPage(
   ...
   helpText("Select the start date by sliding ", strong("Since Year"), " and status of volunteering time by selecting ", strong("Claim Level"), ". Volunteering data on or after the given year start is calculated and displayed. Claim Level/Status may be: ", strong("Claimed"), " - hours reported by the volunteer; ", strong("Verified"), " - hours verified by a third-party such as the person or organization the volunteering was done for, and ", strong("Approved"), " - hours approved by a school counselor toward graduation, extracurricular, or other goals set by the school."),
   helpText("Circles on the map represent zip codes where student volunteers live. Circles are shaded to show the number of volunteers and sized to show the total number of hours they volunteered (of the status/claim level requested). In clustered areas, hover over the area to magnify the area. Hover over individual markers to show detail containing the location and total volunteering hours."),
